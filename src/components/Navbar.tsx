              ...
              {isNavbarOpen && (
                ...
                >
                  <div className="navbar-nav w-100">
                    {/* Dropdown Item */}
                    <div className="nav-item dropdown dropright position-relative">
                      <button
                        onClick={() => setIsDropdownOpen(!isDropdownOpen)}
                        className="nav-link dropdown-toggle d-flex justify-content-between align-items-center w-100 bg-transparent border-0 text-start"
                    ...
                    {[
                      ...
                      <a href="#" className="nav-item nav-link" key={item}>
                        {item}
                      </a>
                    ))}
                  </div>
